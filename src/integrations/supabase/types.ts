  ...
  public: {
    Tables: {
      ...
      voluntarios_pendentes: Table<
        { id: string; nome: string; telefone: string; disponibilidade: string; casa_oracao: string; created_at: string },
        { id?: string; nome: string; telefone?: string; disponibilidade?: string; casa_oracao: string; created_at?: string },
        { nome?: string; telefone?: string; disponibilidade?: string; casa_oracao?: string }
      >;
